...
export const getAllProductUsersHandler = async (req, res) => {
  try {
...
export const getProductUserByIdHandler = async (req, res) => {
  const { id } = req.params;
  try {
    const [users] = await pool.query(
...
export const AddProductUserHandler = async (req, res) => {
